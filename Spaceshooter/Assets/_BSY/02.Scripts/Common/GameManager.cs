...
public class GameManager : MonoBehaviour
{
    ...
    //ItemList 하위에 이쓴 네 개의 아이템을 저장할 배열
    ...
    {
        //DataManager를 통해 파일에 저장된 데이터 불러오기 - ScriptableObject는 전역적으로 접근 가능해서 별도로 불러올 필요가 없다.
    ...
    //인벤토리에서 아이템을 제거했을 때 데이ㅓ를 갱신하는 함수

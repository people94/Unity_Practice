...
//클래스는System.Serializable이라는 어트리뷰트(Attribute)를 명시해야
//인스펙터 뷰에 노출됨
[System.Serializable]
...
public class PlayerCtrl : MonoBehaviour
{
    ...
    //이동 속도 변수(public으로 선언되어 Inspedctor에 노출됨)
    ...
    //Anumation 컴포넌트를 저장하기 위한 변수
    //[HideInInspector]   //인스펙터창에서 숨긴다.
    [System.NonSerialized]  //마찬가지
